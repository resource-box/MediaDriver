...
public final class ListStatusMessageDecoder
{
    ...
    private final ListStatusMessageDecoder parentMessage = this;
    ...
    public ListStatusMessageDecoder wrap(
    ...
    public ListStatusMessageDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ListStatusMessageDecoder sbeRewind()
    {
        ...
        implements Iterable<TimestampDecoder>, java.util.Iterator<TimestampDecoder>
    {
        ...
        private final ListStatusMessageDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        TimestampDecoder(final ListStatusMessageDecoder parentMessage)
        {
        ...
        implements Iterable<EntriesDecoder>, java.util.Iterator<EntriesDecoder>
    {
        ...
        EntriesDecoder(final ListStatusMessageDecoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public ListStatusMessageDecoder sbeSkip()
    {
        sbeRewind();
